    ...
    if (err) {
      ...
      fs.readdir('premium', (err, pstockFiles) => {
        if (err) {
          ...
          <html>
          <head>
          <title>AkaServices Dashboard</title>
...
.inline-text {
  ...
  margin-left: 5px; /* Add some spacing between "Developed by" and "AkaTriggered" */
}
...
<div class="floating-heart">
		...
		<div class="tooltip"> Developed By AkaTriggered</div>
	  </div>
...
app.get('/help', requireLogin, (req, res) => {
  ...
  <head>
  <title>AkaServices Dashboard -help</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    <link rel="icon" href="https://cdn.discordapp.com/attachments/1152538414017687684/1154710899525947422/gift.jpg" type="image/jpg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@6.0.1/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
<div class="features">
    <h2>Features</h2>
    <ul>
      <li><strong>Automated Giveaways:</strong> AkaServices automates the entire giveaway process, from start to finish. Simply set up the giveaway parameters, and AkaServices will handle the rest, including participant entry tracking, winner selection, and prize distribution.</li>
      <li><strong>Safety and Security:</strong> AkaServices ensures a safe and secure giveaway experience. The bot employs various anti-cheat measures to prevent fraudulent entries, ensuring fairness for all participants.</li>
      <li><strong>Easy Configuration:</strong> Setting up AkaServices is a breeze. The bot provides an intuitive and user-friendly setup process, guiding you through each step to configure the giveaway settings according to your preferences.</li>
    </ul>
  </div>
...
app.get('/settings', requireLogin, (req, res) => {
  ...
  <head>
  <title>AkaServices Dashboard -settings</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
  <link rel="icon" href="https://cdn.discordapp.com/attachments/1152538414017687684/1154710899525947422/gift.jpg" type="image/jpg">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/ionicons@6.0.1/dist/css/ionicons.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
...
.bot-commands strong {
  ...
  <div class="main">
    ...
    <form id="settings-form">
        ...
        <!-- Include the additional config variables in the form -->
        <label for="guildId">Guild ID:</label>
        <input type="text" id="guildId" name="guildId" value="${config.guildId}"><br><br>
        <label for="adChannelId">Advertisement Channel ID:</label>
        <input type="text" id="adChannelId" name="adChannelId" value="${config.adChannelId}"><br><br>

        <label for="clientId">Client ID:</label>
        <input type="text" id="clientId" name="clientId" value="${config.clientId}"><br><br>

        <label for="reportschannelid">Reports Channel ID:</label>
        <input type="text" id="reportschannelid" name="reportschannelid" value="${config.reportschannelid}"><br><br>

        <label for="supportCategoryId">Support Category ID:</label>
        <input type="text" id="supportCategoryId" name="supportCategoryId" value="${config.supportCategoryId}"><br><br>

        <label for="closedTicketsCategoryId">Closed Tickets Category ID:</label>
        <input type="text" id="closedTicketsCategoryId" name="closedTicketsCategoryId" value="${config.closedTicketsCategoryId}"><br><br>

        <label for="logChannelId">Log Channel ID:</label>
        <input type="text" id="logChannelId" name="logChannelId" value="${config.logChannelId}"><br><br>
...
<html>
<head>
<title>AkaServices Editor</title>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
<link rel="icon" href="https://cdn.discordapp.com/attachments/1152538414017687684/1154710899525947422/gift.jpg" type="image/jpg">
